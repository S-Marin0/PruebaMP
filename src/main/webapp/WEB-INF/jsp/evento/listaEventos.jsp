                ...
                <c:when test="${not empty listaEventos}">
                    <c:forEach var="evento" items="${listaEventos}">
                        <div class="event-item">
                            ...
                            <p><strong>Fecha:</strong> <fmt:formatDate value="${evento.fechaHora}" type="BOTH" dateStyle="long" timeStyle="short" /></p>
                            ...
                            <p>${evento.descripcion.length() > 100 ? evento.descripcion.substring(0, 100) : evento.descripcion}...
